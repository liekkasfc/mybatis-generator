...
public class MybatisMapperJunitPlugin extends PluginAdapter{
	...
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
		...
		String pojoPackage=targetPackage.substring(0,targetPackage.indexOf("persistence"))+"persistence.entity."+tableName;
	...
	private Method addCRUD(TopLevelClass topLevelClass,
		...
		method.addBodyLine("List<"+pojoType.getShortName()+"> "+pojoType.getShortName()+"s ="+getDaoShort()+"selectByCondition(criteria);");
		...
		method.addBodyLine("criteria.setLimitStart(0);");
		method.addBodyLine("criteria.setLimitEnd(10);");
		method.addBodyLine(pojoType.getShortName()+"s ="+getDaoShort()+"selectByCondition(criteria);");
		method.addBodyLine("assertEquals(1,"+pojoType.getShortName()+"s.size());");
